...
OUTPUT_TAG=${OUTPUT_TAG:-"dcf_v5_1_gated_stage1"}
RUN_LABEL=${RUN_LABEL:-""}
DEFAULT_CASES=(superblue16 superblue3 superblue18)
METHOD_KEYS=${METHOD_KEYS:-"dcf_v5_hybrid_l010,dcf_v5_1_gated_g010,dcf_v5_1_gated_g025,dcf_v5_1_gated_g050"}
...
METHOD_SPECS=(
  ...
  "dcf_v5_1_gated_g010|DCF v5.1 gated hybrid|dcf_hybrid||0.10|0.10"
  "dcf_v5_1_gated_g025|DCF v5.1 gated hybrid|dcf_hybrid||0.10|0.25"
  "dcf_v5_1_gated_g050|DCF v5.1 gated hybrid|dcf_hybrid||0.10|0.50"
)
